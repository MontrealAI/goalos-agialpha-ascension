...
- No guaranteed token classification claim.
- No investment/yield/price/revenue-share claim.
- CI cannot deploy mainnet.
- Runtime RPC/key required locally for actual broadcast.
- No new AGIALPHA token is deployed.
