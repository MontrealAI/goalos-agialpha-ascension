...
Generated: 2026-06-11T19:40:13.673848+00:00
...
- PRIVATE_OPERATOR_EVIDENCE_PENDING: missing qa/public-toolchain-clearance-evidence.json

## Public/private evidence boundary
- Public GitHub stores redacted commitments only.
- Private RPC URLs, keys, signatures, and addresses are not required in GitHub.
