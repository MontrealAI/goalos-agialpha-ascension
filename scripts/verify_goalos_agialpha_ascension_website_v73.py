...
def main():
    ...
    for needle in ["v73 Dynamic AI Visual System","ai-field","data-ai-count","Turn AI work into"]:
    ...
    for name in ["executive-brief.html","proof-observatory.html","ascension.html","proof-treasury.html"]:
        ...
        if "ai-hero" not in text or "ai-field" not in text: fail(f"{name} missing dynamic AI hero/effects")
    ...
    print("GoalOS AGIALPHA Ascension Website v73 verification passed.")
