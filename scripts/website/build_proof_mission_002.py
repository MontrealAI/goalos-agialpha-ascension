...
<section class="ap-section light"><div class="ap-shell"><div class="ap-horizon"><span class="ap-eyebrow">The next horizon</span><h3>{esc(content['mission3']['title'])}</h3><p>{esc(content['mission3']['copy'])}</p><p><strong>Status:</strong> {esc(content['mission3']['status']).replace('_', ' ').title()}.</p></div></div></section>
