...
def main():
    ...
    for marker in ['proof-card-command-center','Proof Card Command Center','proof-card-017.html','proof-cards.html']:
        if marker not in index: fail(f'homepage missing marker {marker}')
    for i in range(1,18):
    ...
    print('Main website root + Proof Cards 001-017 verification passed.')
