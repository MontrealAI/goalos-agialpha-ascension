...
def inject_homepage(index_path:Path):
    ...
    txt=re.sub(r'<style id="proof-card-atlas-v\d+-style">.*?<section class="proof-card-command-center".*?</section>','',txt,flags=re.S)
    txt=re.sub(r'<style id="proof-card-atlas-v\d+-style">.*?</style>\s*<section class="proof-card-command-center".*?</section>','',txt,flags=re.S)
