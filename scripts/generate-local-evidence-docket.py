...
docket={'status':'LOCAL_SIMULATION_ONLY','generatedAt':datetime.datetime.now(datetime.timezone.utc).isoformat(),'manifest':'deployments/local.agialpha.latest.json','manifestHash':sha(manifest),'mainnetEvidence':False,'publicSepoliaEvidence':False,'redacted':True,'containsSecrets':False,'containsPrivateAddresses':False}
