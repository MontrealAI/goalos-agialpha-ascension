#!/usr/bin/env python3
"""Verify GoalOS AGIALPHA Ascension Website v75 static site."""
...
REQUIRED_PAGES = [
    ...
    "proof-treasury.html", "proof-cards.html", "resources.html", "mission-builder.html", "autopilot.html",
...
def main() -> int:
    ...
    (qa_dir/"QA_ASCENSION_WEBSITE_v75.md").write_text("\n".join(md)+"\n", encoding="utf-8")
    if errors:
