#!/usr/bin/env python3
"""Build the GoalOS AGIALPHA Ascension Website v75 Apex static Pages artifact.
...
RELEASE = "GoalOS AGIALPHA Ascension Website v75 — Apex Institutional Command"
VERSION = "v75-apex"
...
def write_qa(out: Path, copied: list[str]) -> None:
    ...
    (qa_dir / "QA_ASCENSION_WEBSITE_v75_APEX.json").write_text(
    ...
    (qa_dir / "QA_ASCENSION_WEBSITE_v75_APEX.md").write_text("\n".join(md) + "\n", encoding="utf-8")
